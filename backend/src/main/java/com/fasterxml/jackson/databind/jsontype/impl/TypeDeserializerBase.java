...
/**
 * Deserialize with multiple levels of polymorphic type hierachy see:
 * https://github.com/FasterXML/jackson-databind/issues/374
 *
 * <p>Fork: https://github.com/FasterXML/jackson-databind/pull/2584
 */
...
public abstract class TypeDeserializerBase extends TypeDeserializer {
   ...
   * @param idRes idRes
   * @param typePropertyName typePropertyName
   * @param typeIdVisible typeIdVisible
   * @param defaultImpl defaultImpl
   * @since 2.8
   */
  ...
  protected final JsonDeserializer<Object> _findDeserializer(
    ...
    if (deser == null) {
      ...
      if (type == null) {
        ...
        if ((_baseType != null) && !_baseType.getTypeName().equals(type.getTypeName())) {
